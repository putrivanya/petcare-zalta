...
// PENTING:
//
// Booking harus dipasang SEBELUM:
// app.use("/api", adminRoutes)
//
// Karena adminRoutes menggunakan prefix /api.
// Kalau bookingRoutes ditaruh setelah adminRoutes,
// request /api/bookings bisa ditangani oleh adminRoutes
// terlebih dahulu.
//
// ======================================================
...
app.get("/", (req, res) => {
  res.json({
    ...
    message:
      "Backend PetCare Hub Zalta berjalan",
...
const startServer = async () => {  
  ...
  try {  
    ...
    // DIGANTI KE ALTER: TRUE
    // Menyesuaikan struktur kolom MySQL dengan model tanpa menghapus data yang ada.
